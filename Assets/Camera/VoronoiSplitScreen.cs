   ...
   public RenderTexture camRT1;
    ...
    void Update()
    {
        ...
        float distance = Vector2.Distance(player1.transform.position, player2.transform.position);
            ...
            //Vector2 playernormalized = new Vector2((player1.position.x + player2.position.x) / 2, (player1.position.y + player2.position.y) / 2);      
        ...
        // TEMPORARY REMOVE LATER,THIS IS JUST FOR NOW TO MAKE SURE THE SHOOTY THINGY WORKS
        //Cam3.transform.position = ConvergedPos;
    ...
    //public static void LookPlayers()
    //{
       // player1 = GameObject.Find("Player");
       // player2 = GameObject.Find("Player2");
      //  Debug.Log("it worked kindof");
    //}
}
